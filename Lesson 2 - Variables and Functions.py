...
greeting()
print("-----------")
#Another thing functions can do is take new data which is the equivalent of you stuffing another cable into the "electronics" box. 
...
print("-----------")
#Try to make your own function taking an order in a coffee shop. Take the size and type of drink. (Look to the cash withdrawal for an example)
#---------------
#region - Answer
...
print("-----------")
#You may have noticed that inside of the functions I have used the letter f before the string. This is an alternative to using .format() a method which allows the connection with the inputs. Using the shorthand f is far more accepted now.
...
#A few additional notes -
    ...
    #To comment out/in text in the terminal you can use ctrl and foreword slash.
